...
//categories
 ...
 String? get selectedCategoryId; String? get selectedSort; int? get selectedSortIndex; double? get selectedMaxDeliveryFee; LoadStatus get filteredRestaurantsLoadStatus; List<RestaurantEntity> get filteredRestaurants;//selected item bottom navigation
 int get selectedBottomNavig; String? get errorMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.categoryLoadStatus, categoryLoadStatus) || other.categoryLoadStatus == categoryLoadStatus)&&const DeepCollectionEquality().equals(other.categories, categories)&&(identical(other.bestPartnersLoadStatus, bestPartnersLoadStatus) || other.bestPartnersLoadStatus == bestPartnersLoadStatus)&&const DeepCollectionEquality().equals(other.bestPartners, bestPartners)&&(identical(other.selectedRestaurantSort, selectedRestaurantSort) || other.selectedRestaurantSort == selectedRestaurantSort)&&const DeepCollectionEquality().equals(other.restaurants, restaurants)&&const DeepCollectionEquality().equals(other.restaurantLoadStatus, restaurantLoadStatus)&&(identical(other.selectedCategoryId, selectedCategoryId) || other.selectedCategoryId == selectedCategoryId)&&(identical(other.selectedSort, selectedSort) || other.selectedSort == selectedSort)&&(identical(other.selectedSortIndex, selectedSortIndex) || other.selectedSortIndex == selectedSortIndex)&&(identical(other.selectedMaxDeliveryFee, selectedMaxDeliveryFee) || other.selectedMaxDeliveryFee == selectedMaxDeliveryFee)&&(identical(other.filteredRestaurantsLoadStatus, filteredRestaurantsLoadStatus) || other.filteredRestaurantsLoadStatus == filteredRestaurantsLoadStatus)&&const DeepCollectionEquality().equals(other.filteredRestaurants, filteredRestaurants)&&(identical(other.selectedBottomNavig, selectedBottomNavig) || other.selectedBottomNavig == selectedBottomNavig)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}


@override
int get hashCode => Object.hash(runtimeType,categoryLoadStatus,const DeepCollectionEquality().hash(categories),bestPartnersLoadStatus,const DeepCollectionEquality().hash(bestPartners),selectedRestaurantSort,const DeepCollectionEquality().hash(restaurants),const DeepCollectionEquality().hash(restaurantLoadStatus),selectedCategoryId,selectedSort,selectedSortIndex,selectedMaxDeliveryFee,filteredRestaurantsLoadStatus,const DeepCollectionEquality().hash(filteredRestaurants),selectedBottomNavig,errorMessage);

@override
String toString() {
  return 'HomeState(categoryLoadStatus: $categoryLoadStatus, categories: $categories, bestPartnersLoadStatus: $bestPartnersLoadStatus, bestPartners: $bestPartners, selectedRestaurantSort: $selectedRestaurantSort, restaurants: $restaurants, restaurantLoadStatus: $restaurantLoadStatus, selectedCategoryId: $selectedCategoryId, selectedSort: $selectedSort, selectedSortIndex: $selectedSortIndex, selectedMaxDeliveryFee: $selectedMaxDeliveryFee, filteredRestaurantsLoadStatus: $filteredRestaurantsLoadStatus, filteredRestaurants: $filteredRestaurants, selectedBottomNavig: $selectedBottomNavig, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 LoadStatus categoryLoadStatus, List<CategoryEntity> categories, LoadStatus bestPartnersLoadStatus, List<RestaurantEntity> bestPartners, RestaurantSort selectedRestaurantSort, Map<RestaurantSort, List<RestaurantEntity>> restaurants, Map<RestaurantSort, LoadStatus> restaurantLoadStatus, String? selectedCategoryId, String? selectedSort, int? selectedSortIndex, double? selectedMaxDeliveryFee, LoadStatus filteredRestaurantsLoadStatus, List<RestaurantEntity> filteredRestaurants, int selectedBottomNavig, String? errorMessage
});
...
as String?,selectedSortIndex: freezed == selectedSortIndex ? _self.selectedSortIndex : selectedSortIndex // ignore: cast_nullable_to_non_nullable
as int?,selectedMaxDeliveryFee: freezed == selectedMaxDeliveryFee ? _self.selectedMaxDeliveryFee : selectedMaxDeliveryFee // ignore: cast_nullable_to_non_nullable
...
as List<RestaurantEntity>,selectedBottomNavig: null == selectedBottomNavig ? _self.selectedBottomNavig : selectedBottomNavig // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus categoryLoadStatus,  List<CategoryEntity> categories,  LoadStatus bestPartnersLoadStatus,  List<RestaurantEntity> bestPartners,  RestaurantSort selectedRestaurantSort,  Map<RestaurantSort, List<RestaurantEntity>> restaurants,  Map<RestaurantSort, LoadStatus> restaurantLoadStatus,  String? selectedCategoryId,  String? selectedSort,  int? selectedSortIndex,  double? selectedMaxDeliveryFee,  LoadStatus filteredRestaurantsLoadStatus,  List<RestaurantEntity> filteredRestaurants,  int selectedBottomNavig,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeState() when $default != null:
return $default(_that.categoryLoadStatus,_that.categories,_that.bestPartnersLoadStatus,_that.bestPartners,_that.selectedRestaurantSort,_that.restaurants,_that.restaurantLoadStatus,_that.selectedCategoryId,_that.selectedSort,_that.selectedSortIndex,_that.selectedMaxDeliveryFee,_that.filteredRestaurantsLoadStatus,_that.filteredRestaurants,_that.selectedBottomNavig,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus categoryLoadStatus,  List<CategoryEntity> categories,  LoadStatus bestPartnersLoadStatus,  List<RestaurantEntity> bestPartners,  RestaurantSort selectedRestaurantSort,  Map<RestaurantSort, List<RestaurantEntity>> restaurants,  Map<RestaurantSort, LoadStatus> restaurantLoadStatus,  String? selectedCategoryId,  String? selectedSort,  int? selectedSortIndex,  double? selectedMaxDeliveryFee,  LoadStatus filteredRestaurantsLoadStatus,  List<RestaurantEntity> filteredRestaurants,  int selectedBottomNavig,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _HomeState():
return $default(_that.categoryLoadStatus,_that.categories,_that.bestPartnersLoadStatus,_that.bestPartners,_that.selectedRestaurantSort,_that.restaurants,_that.restaurantLoadStatus,_that.selectedCategoryId,_that.selectedSort,_that.selectedSortIndex,_that.selectedMaxDeliveryFee,_that.filteredRestaurantsLoadStatus,_that.filteredRestaurants,_that.selectedBottomNavig,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@override final  int? selectedSortIndex;
...
@override@JsonKey() final  int selectedBottomNavig;
