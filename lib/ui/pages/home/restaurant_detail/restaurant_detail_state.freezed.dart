...
//restaurant detail
 ...
 LoadStatus get menuItemDetailLoadStatus; MenuItemDetailEntity? get menuItemDetail;//add restaurant to favorite
 bool get isFavorite; bool get isChangingFavorite;//app bar state
 bool get isCollapsedAppBar;//menu item to order
 LoadStatus get addToCartLoadStatus; int get itemSizeSelectedIndex; int get itemSizePrice; String get itemSizeId; double get price; int get itemQuantity;//cart
 int get cartItemCount;//error message
...
/// Create a copy of RestaurantDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? restaurantLoadStatus = null,Object? restaurantDetail = freezed,Object? menuLoadStatus = null,Object? menuSections = null,Object? reviewLoadStatus = null,Object? reviewSections = null,Object? menuItemDetailLoadStatus = null,Object? menuItemDetail = freezed,Object? isFavorite = null,Object? isChangingFavorite = null,Object? isCollapsedAppBar = null,Object? addToCartLoadStatus = null,Object? itemSizeSelectedIndex = null,Object? itemSizePrice = null,Object? itemSizeId = null,Object? price = null,Object? itemQuantity = null,Object? cartItemCount = null,Object? errorMessage = freezed,}) {
...
as MenuItemDetailEntity?,isFavorite: null == isFavorite ? _self.isFavorite : isFavorite // ignore: cast_nullable_to_non_nullable
as bool,isChangingFavorite: null == isChangingFavorite ? _self.isChangingFavorite : isChangingFavorite // ignore: cast_nullable_to_non_nullable
...
as bool,addToCartLoadStatus: null == addToCartLoadStatus ? _self.addToCartLoadStatus : addToCartLoadStatus // ignore: cast_nullable_to_non_nullable
as LoadStatus,itemSizeSelectedIndex: null == itemSizeSelectedIndex ? _self.itemSizeSelectedIndex : itemSizeSelectedIndex // ignore: cast_nullable_to_non_nullable
as int,itemSizePrice: null == itemSizePrice ? _self.itemSizePrice : itemSizePrice // ignore: cast_nullable_to_non_nullable
as int,itemSizeId: null == itemSizeId ? _self.itemSizeId : itemSizeId // ignore: cast_nullable_to_non_nullable
...
as int,cartItemCount: null == cartItemCount ? _self.cartItemCount : cartItemCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LoadStatus restaurantLoadStatus,  RestaurantDetailEntity? restaurantDetail,  LoadStatus menuLoadStatus,  List<MenuSectionEntity> menuSections,  LoadStatus reviewLoadStatus,  List<ReviewEntity> reviewSections,  LoadStatus menuItemDetailLoadStatus,  MenuItemDetailEntity? menuItemDetail,  bool isFavorite,  bool isChangingFavorite,  bool isCollapsedAppBar,  LoadStatus addToCartLoadStatus,  int itemSizeSelectedIndex,  int itemSizePrice,  String itemSizeId,  double price,  int itemQuantity,  int cartItemCount,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RestaurantDetailState() when $default != null:
return $default(_that.restaurantLoadStatus,_that.restaurantDetail,_that.menuLoadStatus,_that.menuSections,_that.reviewLoadStatus,_that.reviewSections,_that.menuItemDetailLoadStatus,_that.menuItemDetail,_that.isFavorite,_that.isChangingFavorite,_that.isCollapsedAppBar,_that.addToCartLoadStatus,_that.itemSizeSelectedIndex,_that.itemSizePrice,_that.itemSizeId,_that.price,_that.itemQuantity,_that.cartItemCount,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LoadStatus restaurantLoadStatus,  RestaurantDetailEntity? restaurantDetail,  LoadStatus menuLoadStatus,  List<MenuSectionEntity> menuSections,  LoadStatus reviewLoadStatus,  List<ReviewEntity> reviewSections,  LoadStatus menuItemDetailLoadStatus,  MenuItemDetailEntity? menuItemDetail,  bool isFavorite,  bool isChangingFavorite,  bool isCollapsedAppBar,  LoadStatus addToCartLoadStatus,  int itemSizeSelectedIndex,  int itemSizePrice,  String itemSizeId,  double price,  int itemQuantity,  int cartItemCount,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _RestaurantDetailState():
return $default(_that.restaurantLoadStatus,_that.restaurantDetail,_that.menuLoadStatus,_that.menuSections,_that.reviewLoadStatus,_that.reviewSections,_that.menuItemDetailLoadStatus,_that.menuItemDetail,_that.isFavorite,_that.isChangingFavorite,_that.isCollapsedAppBar,_that.addToCartLoadStatus,_that.itemSizeSelectedIndex,_that.itemSizePrice,_that.itemSizeId,_that.price,_that.itemQuantity,_that.cartItemCount,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
class _RestaurantDetailState implements RestaurantDetailState {
  const _RestaurantDetailState({this.restaurantLoadStatus = LoadStatus.initial, this.restaurantDetail, this.menuLoadStatus = LoadStatus.initial, final  List<MenuSectionEntity> menuSections = const [], this.reviewLoadStatus = LoadStatus.initial, final  List<ReviewEntity> reviewSections = const [], this.menuItemDetailLoadStatus = LoadStatus.initial, this.menuItemDetail, this.isFavorite = false, this.isChangingFavorite = false, this.isCollapsedAppBar = false, this.addToCartLoadStatus = LoadStatus.initial, this.itemSizeSelectedIndex = 1, this.itemSizePrice = 0, this.itemSizeId = "", this.price = 0, this.itemQuantity = 0, this.cartItemCount = 0, this.errorMessage}): _menuSections = menuSections,_reviewSections = reviewSections;
...
@override@JsonKey() final  bool isChangingFavorite;
//app bar state
@override@JsonKey() final  bool isCollapsedAppBar;
//menu item to order
@override@JsonKey() final  LoadStatus addToCartLoadStatus;
@override@JsonKey() final  int itemSizeSelectedIndex;
@override@JsonKey() final  int itemSizePrice;
@override@JsonKey() final  String itemSizeId;
...
@override
int get hashCode => Object.hashAll([runtimeType,restaurantLoadStatus,restaurantDetail,menuLoadStatus,const DeepCollectionEquality().hash(_menuSections),reviewLoadStatus,const DeepCollectionEquality().hash(_reviewSections),menuItemDetailLoadStatus,menuItemDetail,isFavorite,isChangingFavorite,isCollapsedAppBar,addToCartLoadStatus,itemSizeSelectedIndex,itemSizePrice,itemSizeId,price,itemQuantity,cartItemCount,errorMessage]);
