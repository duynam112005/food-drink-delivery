...
@override
int get hashCode => Object.hash(runtimeType,restaurantLoadStatus,restaurantDetail,menuLoadStatus,const DeepCollectionEquality().hash(menuSections),reviewLoadStatus,const DeepCollectionEquality().hash(reviewSections),menuItemDetailLoadStatus,menuItemDetail,isFavorite,isChangingFavorite,isCollapsedAppBar,itemSizeSelectedIndex,errorMessage);

@override
String toString() {
  return 'RestaurantDetailState(restaurantLoadStatus: $restaurantLoadStatus, restaurantDetail: $restaurantDetail, menuLoadStatus: $menuLoadStatus, menuSections: $menuSections, reviewLoadStatus: $reviewLoadStatus, reviewSections: $reviewSections, menuItemDetailLoadStatus: $menuItemDetailLoadStatus, menuItemDetail: $menuItemDetail, isFavorite: $isFavorite, isChangingFavorite: $isChangingFavorite, isCollapsedAppBar: $isCollapsedAppBar, itemSizeSelectedIndex: $itemSizeSelectedIndex, errorMessage: $errorMessage)';
}
...
switch (_that) {
case _RestaurantDetailState() when $default != null:
return $default(_that.restaurantLoadStatus,_that.restaurantDetail,_that.menuLoadStatus,_that.menuSections,_that.reviewLoadStatus,_that.reviewSections,_that.menuItemDetailLoadStatus,_that.menuItemDetail,_that.isFavorite,_that.isChangingFavorite,_that.isCollapsedAppBar,_that.itemSizeSelectedIndex,_that.errorMessage);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,restaurantLoadStatus,restaurantDetail,menuLoadStatus,const DeepCollectionEquality().hash(_menuSections),reviewLoadStatus,const DeepCollectionEquality().hash(_reviewSections),menuItemDetailLoadStatus,menuItemDetail,isFavorite,isChangingFavorite,isCollapsedAppBar,itemSizeSelectedIndex,errorMessage);
