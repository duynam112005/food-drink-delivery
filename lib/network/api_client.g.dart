...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<ApiResponseDTO<AuthDTO>> refreshToken(
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponseDTO<SearchDTO>> search({required String query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'q': query};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponseDTO<SearchDTO>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/search',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseDTO<SearchDTO> _value;
    try {
      _value = ApiResponseDTO<SearchDTO>.fromJson(
        _result.data!,
        (json) => SearchDTO.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<ApiResponseDTO<RestaurantMenuDTO>> getRestaurantMenu(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponseDTO<RestaurantMenuDTO>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseDTO<RestaurantMenuDTO> _value;
    try {
      _value = ApiResponseDTO<RestaurantMenuDTO>.fromJson(
        _result.data!,
        (json) => RestaurantMenuDTO.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<ApiResponseDTO<List<ReviewDTO>>> getRestaurantReviews(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponseDTO<List<ReviewDTO>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseDTO<List<ReviewDTO>> _value;
    try {
      _value = ApiResponseDTO<List<ReviewDTO>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<ReviewDTO>(
  ...
  Future<ApiResponseDTO<MenuItemDetailDTO>> getMenuItemDetail(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponseDTO<MenuItemDetailDTO>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponseDTO<MenuItemDetailDTO> _value;
    try {
      _value = ApiResponseDTO<MenuItemDetailDTO>.fromJson(
        _result.data!,
        (json) => MenuItemDetailDTO.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  @override
  Future<void> addRestaurantToFavorite(String restaurantId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> removeRestaurantFromFavorite(String restaurantId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
