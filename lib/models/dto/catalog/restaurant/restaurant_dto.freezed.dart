...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,slug,coverUrl,addressLine,city,rating,ratingCount,deliveryFee,isFreeShipping,etaMinutes,isOpen,status,hasTakeAway,const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(categories),isFavorite);
...
@useResult
$Res call({
 String id, String name, String slug, String coverUrl, String addressLine, String city, double rating, int ratingCount, DeliveryFeeDTO deliveryFee, bool isFreeShipping, int etaMinutes, bool isOpen, String status, bool hasTakeAway, List<String> tags, List<String> categories, bool isFavorite
});
...
switch (_that) {
case _RestaurantDTO() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.coverUrl,_that.addressLine,_that.city,_that.rating,_that.ratingCount,_that.deliveryFee,_that.isFreeShipping,_that.etaMinutes,_that.isOpen,_that.status,_that.hasTakeAway,_that.tags,_that.categories,_that.isFavorite);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,slug,coverUrl,addressLine,city,rating,ratingCount,deliveryFee,isFreeShipping,etaMinutes,isOpen,status,hasTakeAway,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_categories),isFavorite);
